...
const pesanRomantis = [
  "Hai sobat...",
  "Ada sesuatu yang ingin gw sampaikan...",
  "lu pada tuh sahabat gw yg paling gacorrr...",
  "Baru di masa ini gw dapet sahabat kyk lu pada.",
  "Gw berterimakasih kepala lu semua ya...",
  "Dan satu hal yg mau gw bilang...",
  "semoga kita semuanya sukses bray",
  "sehat-sehat"
];
